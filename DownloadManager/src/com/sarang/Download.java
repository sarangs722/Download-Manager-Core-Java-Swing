...
public class Download extends Observable implements Runnable {
	...
	private long downloaded; //no. of bytes downloaded
	...
	private long readSinceStart;	//no. of bytes downloaded since startTime;
	...
	public void run() {
		...
		try {
			...
			//Setting size for this download if it hasn't been already set
			if (size == -1) {
				size = contentLength;
				stateChanged();
			}
